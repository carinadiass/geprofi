					...
					<div class="x_content">
						...
						<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
							...
							<ul class="list-unstyled user_data">
								<li><i class="fa fa-envelope-o user-profile-icon"> </i> <a> ${professor.email}</a>
									</li>
										<li><i class="fa fa-map-marker user-profile-icon"> </i>  ${professor.sala}
									</li>
							...
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target=".bs-example-modal-lg">Editar Perfil</button>
