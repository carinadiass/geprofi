...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
	                    ...
	                    <li>
	                        <a href="${pageContext.request.contextPath}/home/areaPorProfessor">Projetos finalizados</a>
	                    </li>
	                    <li>
    ...
    <header class="intro-header" style="background-image: ${pageContext.request.contextPath}/startbootstrap-clean-blog-1.0.3/img/cape.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1> GeProFi-Gerenciador de Projetos Finais</h1>
                        <hr class="small">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-preview">
                       <img src="${pageContext.request.contextPath}/production/imagens/logoGeProFi.png" style="float: left; margin-top: 0px; width: 100px; height: 50px; background-image: buttonhighlight;" ></img>
                        <!-- h4 class="post-title"--
                            Sobre-
                        </h4-->
                        <br>
